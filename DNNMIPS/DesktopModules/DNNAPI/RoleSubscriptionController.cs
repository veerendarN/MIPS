...
namespace DNNAPI
{
    ...
    public class RoleSubscriptionController : DnnApiController
    {
        ...
        public HttpResponseMessage ExportToExcel(int MC, int OC, int PC, int TBP, string SM)
        {
            ...
            str += "<tr font style='font-weight: bold;'> <td font style='font-weight: bold;'>MeasureNumber</td><td>MeasureTitle</td><td>MeasureType</td><td>MeasureTypeModifier</td><td>Registry</td><td>Domain</td><td>Speciality</td></tr>";
            using (var entity = new DNN8Entities())
            {
